-- billing_eligibility: alinha ao gate tenant-wide (sessões vivas) e unifica a
-- reconexão por rustdesk_id (mesma semântica de create_access_grant / meter_external_session).
